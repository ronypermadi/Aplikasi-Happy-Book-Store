...
if ($menu=="member") {
  ...
  unlink ($tmpfile);
$hasil=mysql_query("UPDATE kasir SET foto='$username-$fileName' WHERE id_kasir='$id_kasir'", $id_mysql);
  ...
  if (!$hasil) {
    ...
    move_uploaded_file($_FILES['gambar']['tmp_name'], "admin/img/hak_akses/".$username.'-'.$fileName);
      ...
      echo "<meta http-equiv='refresh'content='0;url=profil.php?menu=dataku'>";
  }
}
?>
