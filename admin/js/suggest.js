...
function handleSearchSuggest() {
 if (searchReq.readyState == 4) {
  ...
  if(str.length==1)
      ...
      ss.setAttribute('style','position:absolute;top:'+curTop+';left:'+curLeft+';width:250;z-index:1;padding:5px;border: 1px solid #000000; overflow:auto; height:105; background-color:#F5F5FF; border-radius: 3px; -moz-border-radius: 3px; -webkit-border-radius: 3px;');
  ss.innerHTML = '';
