...
<!-- page end-->
          ...
          $bulan = $_POST['bulan'];
          $show_keuntungan_tiap_bulan= mysql_query("SELECT * FROM penjualan WHERE month(tanggal)='$bulan'",$id_mysql);
          ?>
        <!-- page start-->
        <section class="panel">
            <div class="panel-body">
        ...
        <!-- page end-->
                  ...
                  $show_keuntungan_tahun= show_keuntungan_tiap_tahun();
                  ?>
                <!-- page start-->
                <section class="panel">
                    <div class="panel-body">
                      <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                                  <?php $no=1; $total='0'; while ($baris= mysql_fetch_array($show_keuntungan_tahun)){?>
                                      <tr>
                                        <td><?php echo $no; ?></td>
                                        <td><?php echo judul($baris[id_buku]); ?></td>
                                        <td><?php echo list_tanggal($baris[tanggal]); ?></td>
