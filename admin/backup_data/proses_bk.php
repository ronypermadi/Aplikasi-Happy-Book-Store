...
if (isset($_POST['add_user'])) {
  ...
  if (add_user($nama,$alamat,$telepon,$status,$username,$sandi,$akses)) {
...
if (isset($_POST['edit_user'])) {
  ...
  if (edit_user($id_kasir,$nama,$alamat,$telepon,$status,$username,$sandi,$akses)) {
    echo "<meta http-equiv='refresh' content='0;url=menu_user.php?menu=user_kelola1'>";
  }
...
if ($menu=="user_kelola5") { //Add Data Pemilik Rony Permadi
if (isset($_POST['add_user'])) {
  $nama = $_POST['nama'];
  $alamat = $_POST['alamat'];
  $telepon = $_POST['telepon'];
...
if (isset($_POST['edit_buku'])) {
  ...
  if (edit_buku($id_buku,$judul,$noisbn,$penulis,$penerbit,$tahun,$stok,$harga_pokok,$harga_jual,$ppn,$diskon)) {
    echo "<meta http-equiv='refresh' content='0;url=index.php?menu=buku_kelola'>";
  }
