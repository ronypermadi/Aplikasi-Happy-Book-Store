                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            <li><a href="../core/logout.php" onClick="return confirm('Apakah anda yakin ingin  keluar?')"><i class="icon-key"></i> Log Out</a></li>
                        </ul>
                    </li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                if($akses=='1'){
                  ...
                  <li class=sub-menu>
                      <a href=index.php?menu=data_pemesanan>
                          <i class=icon-th></i>
                          <span>Mengelola Pemesanan</span>
                      </a>
                  </li>
                  <li class=sub-menu>
                      <a href=index.php?menu=data_pembayaran>
                          <i class=icon-th></i>
                          <span>Mengelola Pembayaran</span>
                      </a>
                  </li>
                  <li class=sub-menu>
                  ...
                  <li class=sub-menu>
                      ...
                      <li class=sub-menu>
                          ...
                          <li><a href=rekap_pemesanan.php>Rekap Pemesanan</a></li>
                      </ul>
                  </li>";
                }
                if($akses=='2'){
                ...
                if($akses=='3'){
                  ...
                  <li class=sub-menu>
                      <a href=rekap_penjualan_kasir.php>
                          <i class=icon-shopping-cart></i>
