              ...
              <div class="adv-table editable-table ">
                  <div class="clearfix">
                      ...
                      <div class='btn-group pull-right'>
                        <button type=button class=btn btn-primary onClick=javascript:popUp('cetak_buku.php?menu=cetak_buku')>
                  ...
                  <div class="row">
                          ...
                          <div class="panel-footer" align="center">
                            ...
                            <button type="button" class="btn btn-default" data-dismiss="collapse">Close</button>
                          </div></form>
                        </div>
                        ...
                        <?php $no=1;  while ($baris= mysql_fetch_array($show_buku)){?>
                            <tr>
                              ...
                              <td>
                                ...
                                <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#<?php echo $baris['id_buku']; ?>" class="btn green">Edit</button>
                                <!-- Modal -->
                                ...
                                <div class="row">
                                            <div class="col-md-12">
                                              <div class="box">
                                                <div class="box-body" style="width:1150px">
                                                  <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                                      <thead>
                                                      <tr>
                                                          <th>No</th>
                  ...
                  <?php while ($baris= mysql_fetch_array($shows_buku)){ ?>
                  <div id=<?php echo $baris['id_buku']; ?> class="panel-collapse collapse">
                    <div class="panel-body">
                  <div class="row">
                              <div class="col-md-12">
                                    <form action="proses.php" method=POST enctype="multipart/form-data" role="form">
                                   ...
                                   <div class="form-group">
                                        <label>ID Buku :</label>
                                        <input class="form-control" name="id_buku" placeholder="ID Buku" value="<?php echo $baris['id_buku']; ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>Judul :</label>
                                        <input class="form-control" name="judul" placeholder="Judul" value="<?php echo $baris['judul']; ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>ISBN :</label>
                                        <input class="form-control" name="noisbn" placeholder="ISBN" value="<?php echo $baris['noisbn']; ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>Penulis :</label>
                                        <input class="form-control" name="penulis" placeholder="Penulis" value="<?php echo $baris['penulis']; ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>Penerbit :</label>
                                        <input class="form-control" name="penerbit" placeholder="Penerbit" value="<?php echo $baris['penerbit']; ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>Tahun :</label>
                                        <input class="form-control" name="tahun" placeholder="Tahun" value="<?php echo $baris['tahun']; ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>Stok :</label>
                                        <input class="form-control" name="stok" placeholder="Stok" value="<?php echo $baris['stok']; ?>">
                                   </div></div>
                                   <div class="col-md-6">
                                   <div class="form-group">
                                        <label>Harga Pokok :</label>
                                        <input class="form-control" name="harga_pokok" placeholder="Harga Pokok" value="<?php echo number_format($baris['harga_pokok']); ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>Harga Jual :</label>
                                        <input class="form-control" name="harga_jual" placeholder="Harga Jual" value="<?php echo number_format($baris['harga_jual']); ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>PPN :</label>
                                        <input class="form-control" name="ppn" placeholder="PPN" value="<?php echo $baris['ppn']; ?>">
                                   </div>
                                   <div class="form-group">
                                        <label>Diskon :</label>
                                        <input class="form-control" name="diskon" placeholder="Diskon" value="<?php echo $baris['diskon']; ?>">
                                   </div>
                                     <div class="col-md-6">
                                       <div class="form-group">
                                       <label>Gambar :</label><br>
                                       <?php echo "<img id=uploadPreview src=img/buku/".$baris['foto']." width=150 height=150>"; ?><br/>
                                       <input type="file" id="uploadImage"  name="gambar" onchange="PreviewImage();" />
                                     </div>
                                     </div><br/>
                                     <div class="col-md-6">
                                       <div class="form-group">
                                       <label>Keterangan :</label><br>
                                       <textarea class="form-control"  name="keterangan"><?php echo $baris['keterangan']; ?></textarea>
                                     </div>
                                     </div><br/>
                                   </div>
                              </div><!-- /.col -->
                          ...
                          <tbody>
                            <?php $no=1;  while ($baris= mysql_fetch_array($show_buku)){?>
                                <tr>
                                  ...
                                  <td><?php echo $baris['stok'] ?></td>
                                  <td>
                                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#detail-<?php echo $baris['id_buku']; ?>" class="btn btn-primary">Detail</button>                                    <!-- Modal -->
                                    <div class="modal fade" id="detail-<?php echo $baris['id_buku']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" style="width:1200px">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
