                ...
                <div class=clearfix></div>
                  <div class=space15></div>
                    ...
                    <div class='btn-group pull-right'>
                      <button type=button class=btn btn-primary onClick=javascript:popUp('cetak_penjualan.php?menu=cetak_penjualan_hari&hari=$tgl') >
                ...
                <div class=clearfix></div>
                  <div class=space15></div>
                    <div id=kasir_hari class=panel-collapse collapse>
                      ...
                      <div class='btn-group pull-right'>
                        <button type=button class=btn btn-primary onClick=javascript:popUp('cetak_penjualan.php?menu=cetak_penjualan_bulan&bulan=$bulan') >
                          Print <i class=icon-print></i>
                        </button>
                      </div>
                      <table class=table table-striped table-hover table-bordered>
                    ...
                    <div class=clearfix></div>
                      <div class=space15></div>
                        <div id=kasir_hari class=panel-collapse collapse>
                          ...
                          <div class='btn-group pull-right'>
                            <button type=button class=btn btn-primary onClick=javascript:popUp('cetak_penjualan.php?menu=cetak_penjualan_tahun&tahun=$tahun') >
                              Print <i class=icon-print></i>
                            </button>
                          </div>
                          <table class=table table-striped table-hover table-bordered>
