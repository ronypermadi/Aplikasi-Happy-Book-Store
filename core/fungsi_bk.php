...
function show_user1(){
  include 'koneksi.php';
  $hasil = mysql_query("SELECT * FROM kasir WHERE akses=1", $id_mysql);
  return $hasil;
}
function show_user2(){
  include 'koneksi.php';
  $hasil = mysql_query("SELECT * FROM kasir WHERE akses=2", $id_mysql);
  return $hasil;
}
function show_user3(){
  include 'koneksi.php';
  $hasil = mysql_query("SELECT * FROM kasir WHERE akses=3", $id_mysql);
  return $hasil;
}
function show_user4(){
  include 'koneksi.php';
  $hasil = mysql_query("SELECT * FROM kasir WHERE akses=4", $id_mysql);
  return $hasil;
}
function show_user5(){
  include 'koneksi.php';
  $hasil = mysql_query("SELECT * FROM kasir WHERE akses=5", $id_mysql);
  return $hasil;
}
function add_user($nama,$alamat,$telepon,$status,$username,$sandi,$akses){
  include 'koneksi.php';
...
function edit_user($id_kasir,$nama,$alamat,$telepon,$status,$username,$sandi,$akses){
  include 'koneksi.php';
...
function show_buku(){
  include 'koneksi.php';
  $hasil = mysql_query("SELECT * FROM buku", $id_mysql);
  return $hasil;
}
...
function edit_buku($id_buku,$judul,$noisbn,$penulis,$penerbit,$tahun,$stok,$harga_pokok,$harga_jual,$ppn,$diskon){
  include 'koneksi.php';
$hasil=mysql_query("UPDATE buku SET id_buku='$id_buku' , judul='$judul', noisbn='$noisbn' , penulis='$penulis' , penerbit='$penerbit', tahun='$tahun' , stok='$stok', harga_pokok='$harga_pokok', harga_jual='$harga_jual', ppn='$ppn', diskon='$diskon' WHERE id_buku='$id_buku'", $id_mysql);
