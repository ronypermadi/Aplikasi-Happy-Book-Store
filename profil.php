            ...
            <div class="well" align="center"><h5><b>Data <?php echo nama_user($username); ?></b></label></h5></div>
              ...
              <div class="col-md-8">
                ...
                <div class="person text-center">
                  <form action="proses.php?menu=member" method="post" enctype="multipart/form-data" role="form">
                  <?php
                   $sql = mysql_query("SELECT * FROM kasir WHERE username='$username'", $id_mysql);
                   while ($sql1 = mysql_fetch_array($sql)) {
                   ?>
                   <input type="hidden" name="id_kasir" value="<?php echo $sql1['id_kasir'] ?>">
                   <input type="hidden" name="username" value="<?php echo $sql1['username'] ?>">
                    <?php echo "<img id=uploadPreview src=admin/img/hak_akses/".$sql1['foto']." width=150 height=150>"; ?><br/>
                      <div align="center"><input type="file" id="uploadImage"name="gambar" onchange="PreviewImage();"></div>
                      <button type="submit" name="edit_member" class="btn-primary">Simpan</button><br/><br/>
                    <?php } ?>
                </div></form>
                <div class="person-info text-center">
                    ...
                    <table class="table">
                      ...
                      <tr align="left">
                        <td>Status</td><td><?php echo list_status($baris['status']) ?></td>
                      </tr>
                      </tbody>
                        <?php } ?>
                    </table>
